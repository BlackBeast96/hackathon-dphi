...
function Edit_and_Delete(props) {
  ...
  function RemoveData(e) {
    dispatch(Remove(Transfer_Data.id))
    navigate("/");
  }
  ...
  return (
    <>
      <div className='bg-[#003145] text-white pt-20 pl-10 lg:pl-28 space-y-10 pb-20 '>
        <div className='bg-[#FFCE5C] w-80 sm:w-[68vw] lg:w-[50vw] h-8 mr-32 sm:mr-36 text-black md:mr-52 lg:mr-96 xl:mr-[39rem] rounded-md font-bold pl-5 pt-0.5'>
          <AccessTime />
          <div className='inline ml-2 pt-10'>{Transfer_Data.time_title} {Transfer_Data.starting_date} <h1 className='inline invisible sm:visible'> (India Standard Time) </h1></div>
        </div>
