  ...
  return (
    <>
      <div className="bg-[#003145] flex pt-28 pb-20 ">
        <div className='w-4 lg:w-2.5 mt-64 ml-8 lg:ml-44 md:mt-0 md:visible md:relative h-28  bg-yellow-400'></div>
        <div className='ml-10 pt-64 md:pt-0 space-y-14 text-white'>
          <h1 className='lg:w-[50vw] text-6xl w-20 sm:w-[50vw] font-bold'>Accelerate Innovation with Global AI Challenges</h1>
          ...
          <button className="bg-white text-[#074c68] font-bold text-lg rounded-lg h-12 pl-3 pr-3">Create Challenge</button>
        </div>
        <img className='absolute md:relative mt-[-8rem] md:mt-[-16rem] lg:mt-[-2rem] md:w-[29rem] ml-[10vw] sm:ml-[24vw] md:ml-0' src="./icons/rocket.svg" alt="rocket svg image" />
      </div>
